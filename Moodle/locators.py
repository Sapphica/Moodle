...
# --------------locators section-----------------
app = 'Moodle'
admin_username = 'shawnaflannigan'
admin_password ='Happy1pass!'
...
moodle_login_page_title = 'Software Quality Assurance Testing: Log in to site'
...
description = f'User added by{admin_username} via Python Selenium Automated Script'
# ------------------data section-----------------
...
msn_id = f'{last_name.lower()}{fake.pyint(11, 999)}{country}'
...
list_val = [web_page, icq_num, skype_id, aim_id, yahoo_id, msn_id, id_num, institution, department, phone, mobile_phone, address]
# -----------------------------------------------,
